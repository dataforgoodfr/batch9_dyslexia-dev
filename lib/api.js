...
document.addEventListener('DOMContentLoaded', function () {
    ...
    document.querySelector(".btn-upload").addEventListener('click', function () {
        ...
        const local_file_url = 'https://dyslexia-ocr.herokuapp.com/ocr_file/'  ;
        const url = local_file_url;
            ...
            .then((data) => {
                ...
                if (error) {
                    ...
                    switch(code) {
                        ...
                        case 'NO_TEXT_FOUND':
                            // code block
                            message = "Votre document ne semble pas contenir de texte ou n'est pas dans une langue supportée par le système.";
                        break;
                        case 'UNKNOWN_ERROR':
                            // code block
